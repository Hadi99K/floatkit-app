...
*   Attempt to reverse-engineer, decompile, hack, or modify the application.
*   Use Floatkit to record audio or take screenshots of individuals without their consent where legally required.
*   Use the system control features (brightness, volume, power menu) to disrupt, damage, or unauthorizedly access any device or system.
*   Bypass, modify, or tamper with the application's security, billing mechanisms, or license verification. Modified or unauthorized versions of Floatkit may be restricted from operating.
...
*   **Refund Policy:** All refund requests for purchases made within the app are subject to the Google Play Store's refund policies. We cannot issue refunds directly.

## 4. Disclaimer of Warranties

The Floatkit application is provided "AS IS" and "AS AVAILABLE" without any warranties of any kind, whether express or implied. 

We do not warrant that the app will function uninterrupted, be error-free, or be completely secure. Since Floatkit runs as a background overlay, its performance heavily depends on your specific Android device's hardware, OS version, and battery optimization settings.

## 5. Limitation of Liability

In no event shall the developer, Fari Ji, or contributors be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
...
Because Floatkit relies entirely on your device's local storage, we are explicitly not responsible for the loss or deletion of your notes, reminders, bookmarks, voice memos, or tasks (e.g., during app uninstallation, device reset, or unexpected database corruption). While Floatkit offers an Automated Backup feature to help mitigate data loss, the secure storage and management of the exported backup files are entirely your responsibility.

## 6. Changes to Terms

We reserve the right, at our sole discretion, to modify or replace these Terms at any time. We will indicate the date these Terms were last revised. By continuing to access or use our application after those revisions become effective, you agree to be bound by the revised terms.
